            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-black">
                        <div class="box-title">
                            <h3><i class="fa fa-table"></i> @lang('messages.oils.oil_brands')</h3>
                        </div>
                        <div class="box-content">
                            <div class="btn-toolbar pull-right">
                                <div class="btn-group">
                                    @if (get_action_icons('oil_brand/create', 'get'))
                                        <a class="btn btn-circle show-tooltip" title=""
                                            href="{{ url('oil_brand/create') }}" data-original-title="Add new record"><i
                                                class="fa fa-plus"></i></a>
                                    @endif
                                    <?php $table_name = 'oil_brands';
                                        ...
                                        @foreach ($oil_brands as $value)
                                            <tr>
                                                ...
                                                <td class="visible-md visible-xs visible-sm visible-lg">
                                                    <div class="btn-group">
                                                        @if (get_action_icons('oil_brand/{id}/edit', 'get'))
                                                            <a class="btn btn-sm show-tooltip"
                                                                href='{{ url("oil_brand/$value->id/edit") }}'
                                                                title="Edit"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        @if (get_action_icons('oil_brand/{id}/delete', 'get'))
                                                            <form action="{{ route('oil_brand.destroy', $value->id) }}"
